    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        <div className="max-w-3xl">
          ...
          <h1 className="text-6xl font-black text-gray-900 uppercase tracking-tighter leading-none mb-12">
          ...
          <div className="grid grid-cols-2 gap-12 mt-20">
            <div>
               ...
               <ul className="space-y-4 text-[10px] font-black uppercase tracking-widest text-gray-900">
            ...
            <div>
               ...
               <p className="text-[10px] font-black uppercase tracking-widest text-gray-900">Enugu State, Nigeria</p>

      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        <div className="max-w-3xl">
          ...
          <div className="grid grid-cols-2 gap-12 mt-20">
            <div>
               <h3 className="text-[10px] font-black uppercasest text-gray-400 mb-4">Our Values</h3>
               <ul className="space-y-4 text-[10px] font-black uppercasest text-gray-900">
            ...
            <div>
               <h3 className="text-[10px] font-black uppercasest text-gray-400 mb-4">Contact</h3>
               <p className="text-[10px] font-black uppercasest text-gray-900">Enugu State, Nigeria</p>
               <p className="text-[10px] font-black uppercasest text-primary mt-2">contact@ubinex.com.ng</p>
            </div>
          </div>
        </div>
      </main>

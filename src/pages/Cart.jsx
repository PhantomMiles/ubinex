  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        {/* Header */}
        <div className="mb-12">
          <p className="text-[10px] font-black text-gray-400 uppercase mb-3">Shop / Checkout</p>
        ...
        {cart.length > 0 ? (
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div className="flex-1 space-y-8">
                  ...
                  <div className="flex-1 flex flex-col justify-between py-1 font-sans">
                    <div>
                      <div className="flex justify-between items-start mb-2">
                        <h3 className="text-xl font-black text-gray-900 uppercase leading-none">{item.name}</h3>
                        <button 
                          onClick={() => removeFromCart(item.id)}
                          className="text-[9px] font-black text-red-600 uppercasest hover:underline transform active:scale-95"
                        >
                          Delete Item
                        </button>
                      </div>
                      <p className="text-[9px] font-bold text-gray-400 uppercasest mb-1 flex items-center gap-2">
                        <i className="fas fa-leaf text-primary"></i> {item.category}
                      </p>
                      <p className="text-[9px] font-bold text-gray-400 uppercasest flex items-center gap-2">
                    ...
                    <div className="flex items-center justify-between mt-8">
                      ...
                      <div className="text-right">
                        <p className="text-[8px] font-black text-gray-400 uppercasest mb-1">Subtotal Value</p>
              ...
              <button 
                ...
                className="text-[9px] font-black text-gray-400 uppercase hover:text-primary transition flex items-center gap-3 mt-12 bg-gray-50 px-6 py-3 rounded-lg border border-gray-100"
              >
            ...
            <aside className="w-full lg:w-96">
              <div className="bg-[#0a0a0a] text-white p-10 rounded-xl shadow-2xl relative overflow-hidden lg:sticky lg:top-32 border border-white/5">
                ...
                <h2 className="text-2xl font-black uppercase mb-10 border-b border-white/10 pb-6 leading-none">Order Checklist</h2>
                
                <div className="space-y-6 mb-10">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] font-black text-white/40 uppercasest">Subtotal</span>
                    <span className="text-sm font-black">{symbol}{calculateSubtotal().toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] font-black text-white/40 uppercasest">Delivery (Logistics)</span>
                    <span className="text-sm font-black">{symbol}{calculateShipping().toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] font-black text-white/40 uppercasest">VAT (5%)</span>
                ...
                <div className="pt-8 border-t border-white/10 mb-10">
                  <div className="flex justify-between items-end">
                    <div>
                       <p className="text-[10px] font-black text-primary uppercase mb-1">Total Due</p>
                ...
                <button 
                  ...
                  className="w-full bg-primary hover:bg-white hover:text-primary text-white py-5 rounded-lg text-[10px] font-black uppercase shadow-xl transition-all duration-500 active:scale-95"
                >
                  Pay Securely Now
                </button>

                <div className="mt-12 pt-10 border-t border-white/5 space-y-4 font-sans">
                   <div className="flex items-center gap-4 text-[8px] font-bold text-white/30 uppercasest">
          ...
          <div className="py-40 text-center bg-gray-50 rounded-xl border border-dashed border-gray-200 mt-12 font-sans relative overflow-hidden min-h-[500px] flex flex-col items-center justify-center">
             ...
             <div className="relative z-10">
                ...
                <button 
                  onClick={() => navigateTo('categories')}
                  className="bg-[#0a0a0a] text-white px-16 py-5 rounded-lg text-[10px] font-black uppercase shadow-2xl hover:bg-primary transition-all duration-500 active:scale-95 transform"
                >

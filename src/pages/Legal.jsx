  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="max-w-6xl mx-auto px-6 py-20">
        <div className="mb-16">
          <p className="text-[10px] font-black text-primary uppercase mb-4">Regulatory & Safety</p>
          <h1 className="text-5xl font-black text-gray-900 uppercase leading-none mb-4">
            Compliance Hub
          </h1>
          <p className="text-xs text-gray-400 font-bold uppercasest leading-relaxed max-w-2xl">
          ...
          <aside className="w-full lg:w-64 flex flex-col gap-2">
            {sections.map((s) => (
              <button
                ...
                className={`text-left px-8 py-4 rounded-xl text-[10px] font-black uppercasest transition-all duration-300 ${
          ...
          <div className="flex-1 bg-gray-50/50 rounded-3xl p-10 md:p-16 border border-gray-100 animate-in fade-in slide-in-from-right-8 duration-700">
            {activeSec === "tos" && (
              <article className="prose prose-sm max-w-none text-gray-600">
                <h2 className="text-3xl font-black text-gray-900 uppercase mb-10">Terms of Service</h2>
                <div className="space-y-8 text-[11px] uppercaser leading-loose font-bold">
                  <section>
            ...
            {activeSec === "privacy" && (
              <article className="prose prose-sm max-w-none text-gray-600">
                <h2 className="text-3xl font-black text-gray-900 uppercase mb-10">Privacy Policy</h2>
                <div className="space-y-8 text-[11px] uppercaser leading-loose font-bold">
                  <section>
            ...
            {activeSec === "engineering" && (
              <article className="prose prose-sm max-w-none text-gray-600">
                <h2 className="text-3xl font-black text-gray-900 uppercase mb-10">Engineering Standards</h2>
                <div className="space-y-8">
                  <div className="p-8 bg-white rounded-2xl border border-gray-100 shadow-sm relative overflow-hidden">
                    ...
                    <h4 className="text-gray-900 font-black uppercase text-[10px]st mb-4">Core Architecture</h4>
                  ...
                  <div className="p-8 bg-white rounded-2xl border border-gray-100 shadow-sm relative overflow-hidden">
                    <h4 className="text-gray-900 font-black uppercase text-[10px]st mb-4">Security Protocols</h4>

    ...
    <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[95vh] overflow-y-auto font-sans relative">
      ...
      <div className="sticky top-0 bg-white/80 backdrop-blur-md z-20 border-b border-gray-100 p-6 flex justify-between items-center">
        <div>
          ...
          <h2 className="text-xl font-black text-gray-900 uppercase tracking-tighter leading-none">{product.name}</h2>
        </div>
        <button
          onClick={onClose}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3 bg-gray-50 px-4 py-3 rounded-lg border border-gray-100">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-gray-700">{product.location || "Enugu, Nigeria"}</span>
                </div>
                <div className="flex items-center gap-3 bg-gray-50 px-4 py-3 rounded-lg border border-gray-100">
                  <i className="fas fa-certificate text-primary"></i>
                  <span className="text-[10px] font-black uppercase tracking-widest text-gray-700">Verified Grade A</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-xs font-bold text-gray-600 leading-loose uppercase tracking-[0.1em]">
          ...
          <div className="bg-[#0a0a0a] text-white p-8 rounded-xl shadow-2xl relative overflow-hidden flex flex-col justify-between h-full">
            <div className="relative z-10">
               ...
               <div className="flex items-end gap-2 mb-8">
                  <span className="text-5xl font-black text-white line-height-none tracking-tighter">{symbol}{price.toLocaleString()}</span>
            ...
            <div className="space-y-4 relative z-10 mt-auto">
               <button 
                  ...
                  className="w-full bg-primary hover:bg-white hover:text-primary text-white font-black py-5 rounded-lg text-[10px] uppercase tracking-[0.3em] transition-all shadow-xl"
               >
                  Add to Shopping Bag
               </button>
               <button 
                  onClick={() => onNegotiate && onNegotiate()}
                  className="w-full bg-white/10 hover:bg-white/20 text-white font-black py-5 rounded-lg text-[10px] uppercase tracking-[0.3em] transition-all border border-white/10"
               >
                  Negotiate Price
               </button>
            </div>

    ...
    <section className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8 font-sans">
      ...
      <div className="lg:col-span-2 relative rounded-xl overflow-hidden shadow-2xl group h-[450px] lg:h-[550px]">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/30 to-transparent flex flex-col justify-center px-16 text-white z-10">
          <span className="text-primary font-black uppercase tracking-[0.4em] mb-6 animate-in fade-in slide-in-from-left duration-700">Premium Nigerian Harvest</span>
          ...
          <p className="text-xl mb-10 opacity-80 delay-200 animate-in fade-in slide-in-from-left font-bold uppercase tracking-widest">Starting from <span className="text-white font-black">₦45,000</span> <span className="text-xs opacity-50">/ 50kg Bag</span></p>
          <button className="bg-primary hover:bg-white hover:text-primary text-white font-black py-5 px-12 rounded-lg transition-all shadow-2xl w-fit uppercase tracking-[0.3em] text-[10px] delay-300 animate-in fade-in slide-in-from-left transform active:scale-95 border border-white/10">
      ...
      <div className="flex flex-col gap-8 h-[450px] lg:h-[550px]">
        ...
        <div className="flex-1 relative rounded-xl overflow-hidden shadow-2xl group border border-gray-100">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent flex flex-col justify-end p-10 text-white">
            <h3 className="text-2xl font-black mb-3 uppercase tracking-tighter leading-none">Nsukka <br/>Yellow Pepper</h3>
            <p className="text-[9px] uppercase tracking-[0.3em] opacity-80 mb-6 font-black text-primary">Authentic Aroma & Spice</p>
            <button className="text-[9px] font-black uppercase tracking-[0.4em] border-b border-primary w-fit pb-1.5 hover:text-primary transition">Shop Market</button>
          </div>
        </div>
        ...
        <div className="flex-1 relative rounded-xl overflow-hidden shadow-2xl group border border-gray-100">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-gray-900/95 via-gray-900/10 to-transparent flex flex-col justify-end p-10 text-white">
            <h3 className="text-2xl font-black mb-3 uppercase tracking-tighter leading-none">Premium <br/>Local Spices</h3>
            <p className="text-[9px] uppercase tracking-[0.3em] opacity-80 mb-6 font-black text-accent">Ogbono, Crayfish, Egusi</p>
            <button className="text-[9px] font-black uppercase tracking-[0.4em] border-b border-accent w-fit pb-1.5 hover:text-accent transition">View Spices</button>
          </div>
        </div>
      </div>
    </section>

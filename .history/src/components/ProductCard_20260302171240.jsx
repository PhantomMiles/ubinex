		...
		<article className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-200" style={{ borderColor: '#2d5016', borderWidth: '1px' }}>
			...
			<div className="p-4">
				<div className="flex items-start justify-between gap-3">
					...
					<p className="text-xs text-gray-500 mt-1 truncate"><i className="fas fa-tag" style={{ marginRight: '4px', color: '#8B5A3C' }}></i>{product.category} • <i className="fas fa-map-marker-alt" style={{ marginRight: '4px', color: '#8B5A3C' }}></i>{location}</p>

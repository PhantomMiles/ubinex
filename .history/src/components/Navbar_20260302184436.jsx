    ...
    <header className="w-full bg-white shadow-sm sticky top-0 z-20">
      <div className="max-w-full mx-auto px-4 py-3 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="text-white px-3 space-x-2 py-2 rounded-md flex items-center gap-2 hidden sm:inline text-sm transition" style={{ backgroundColor: "#2d5016" }}> 
            <span>Cart <i className="fas fa-shopping-cart"></i>
            </span>

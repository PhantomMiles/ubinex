    ...
    <header className="w-full bg-white shadow-sm sticky top-0 z-20">
      <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-md flex items-center justify-center text-white font-bold text-lg" style={{ backgroundColor: "#2d5016" }}>🌾</div>
          <div>
            <h1 className="text-lg font-semibold text-gray-900">Ubinex</h1>
        ...
        <div className="flex-1 max-w-xl hidden sm:block">
          <label className="relative block">
            ...
            <input
              ...
              className="w-full border border-gray-200 rounded-full py-2 pl-4 pr-10 text-sm shadow-sm focus:outline-none focus:ring-2 focus:border-transparent transition"
              ...
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                <div className="px-4 py-3 border-b border-gray-200">
                  ...
                  <p className="text-xs mt-1" style={{ color: "#2d5016" }}>
                    {user?.role === 'farmer' ? '👨‍🌾 Farmer Account' : '🛒 Consumer Account'}
                  </p>
                </div>
                <button
                  onClick={() => {

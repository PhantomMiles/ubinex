      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg shadow-xl p-8 border border-gray-200">
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            {mode === "signup" && (
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1"><i className="fas fa-check-circle" style={{ color: "#2d5016", marginRight: "8px" }}></i>Confirm Password</label>
                <input
                  type="password"
                  required

	...
	return (
		<div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
			...
			<div className="p-6">
				...
				{/* Description */}
				<div className="mb-6">
					<h3 className="text-sm font-semibold text-gray-900 mb-2"><i className="fas fa-info-circle" style={{ marginRight: '6px', color: '#2d5016' }}></i>About</h3>
				...
				<div className="flex gap-3">
					<button
						...
						className="flex-1 text-white font-semibold py-3 rounded-full hover:shadow-lg transition-all shadow-md flex items-center justify-center"
						style={{ backgroundColor: '#2d5016' }}
					>
						<i className="fas fa-handshake" style={{ marginRight: '8px' }}></i>Negotiate Price
					</button>
					<button className="flex-1 border-2 text-gray-900 font-semibold py-3 rounded-full hover:bg-gray-50 transition-colors flex items-center justify-center" style={{ borderColor: '#8B5A3C' }}>
						<i className="fas fa-cart-plus" style={{ marginRight: '8px', color: '#8B5A3C' }}></i>Add to Cart
					</button>
				</div>
			</div>
		</div>
